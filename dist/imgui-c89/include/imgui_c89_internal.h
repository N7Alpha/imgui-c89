...
typedef struct ImSpan_short ImSpan_short;
typedef struct ImSpanAllocator_6 ImSpanAllocator_6;
...
typedef struct ImVector_ImGuiTable ImVector_ImGuiTable;
...
typedef struct ImVector_ImGuiTableReconcileColumnData ImVector_ImGuiTableReconcileColumnData;
...
struct ImVector_ImGuiTableReconcileColumnData {
    int Size;
    int Capacity;
    ImGuiTableReconcileColumnData * Data;
};
...
struct ImGuiTable {
    ...
    ImSpan_short DisplayOrderToIndex;
...
ImU32 imgui_i_im_alpha_blend_colors(ImU32 col_a, ImU32 col_b);
ImVec2 imgui_i_im_bezier_cubic_calc(const ImVec2 * p1, const ImVec2 * p2, const ImVec2 * p3, const ImVec2 * p4, float t);
ImVec2 imgui_i_im_bezier_cubic_closest_point(const ImVec2 * p1, const ImVec2 * p2, const ImVec2 * p3, const ImVec2 * p4, const ImVec2 * p, int num_segments);
ImVec2 imgui_i_im_bezier_cubic_closest_point_casteljau(const ImVec2 * p1, const ImVec2 * p2, const ImVec2 * p3, const ImVec2 * p4, const ImVec2 * p, float tess_tol);
...
void ImBitArrayClearBit__4dc93cf57e(ImU32 * arr, int n);
size_t ImBitArrayGetStorageSizeInBytes__ac1b7b5bd0(int bitcount);
void ImBitArraySetBit__e371039a31(ImU32 * arr, int n);
void ImBitArraySetBitRange__f8dfc5c166(ImU32 * arr, int n, int n2);
...
float ImDot__02118000e6(const ImVec2 * a, const ImVec2 * b);
unsigned char imgui_i_im_file_close(ImFileHandle f);
ImU64 imgui_i_im_file_get_size(ImFileHandle f);
void * imgui_i_im_file_load_to_memory(ImGuiContext *imgui_c89_ctx, const char * filename, const char * mode, size_t * out_file_size, int padding_bytes);
ImFileHandle imgui_i_im_file_open(const char * filename, const char * mode);
ImU64 imgui_i_im_file_read(void * data, ImU64 sz, ImU64 count, ImFileHandle f);
ImU64 imgui_i_im_file_write(const void * data, ImU64 sz, ImU64 count, ImFileHandle f);
...
int imgui_i_im_format_string(char * buf, size_t buf_size, const char * fmt, ...);
void imgui_i_im_format_string_to_temp_buffer(ImGuiContext *imgui_c89_ctx, const char ** out_buf, const char ** out_buf_end, const char * fmt, ...);
void imgui_i_im_format_string_to_temp_buffer_v(ImGuiContext *imgui_c89_ctx, const char ** out_buf, const char ** out_buf_end, const char * fmt, va_list args);
int imgui_i_im_format_string_v(char * buf, size_t buf_size, const char * fmt, va_list args);
ImGuiID imgui_i_im_hash_data(const void * data_p, size_t data_size, ImGuiID seed);
const char * imgui_i_im_hash_skip_uncontributing_prefix(const char * label);
ImGuiID imgui_i_im_hash_str(const char * data_p, size_t data_size, ImGuiID seed);
...
ImVec2 imgui_i_im_line_closest_point(const ImVec2 * a, const ImVec2 * b, const ImVec2 * p);
...
ImGuiStoragePair * imgui_i_im_lower_bound(ImGuiStoragePair * in_begin, ImGuiStoragePair * in_end, ImGuiID key);
...
void * imgui_i_im_memdup(ImGuiContext *imgui_c89_ctx, const void * src, size_t size);
...
ImVec2 ImMul__d5e5102683(const ImVec2 * lhs, const ImVec2 * rhs);
const char * imgui_i_im_parse_format_find_end(const char * fmt);
const char * imgui_i_im_parse_format_find_start(const char * fmt);
int imgui_i_im_parse_format_precision(const char * fmt, int default_precision);
void imgui_i_im_parse_format_sanitize_for_printing(const char * fmt_in, char * fmt_out, size_t fmt_out_size);
const char * imgui_i_im_parse_format_sanitize_for_scanning(const char * fmt_in, char * fmt_out, size_t fmt_out_size);
const char * imgui_i_im_parse_format_trim_decorations(const char * fmt, char * buf, size_t buf_size);
...
const char * imgui_i_im_str_skip_blank(const char * str);
void imgui_i_im_str_trim_blanks(char * buf);
const char * imgui_i_im_strbol(const char * buf_mid_line, const char * buf_begin);
const char * imgui_i_im_strchr_range(const char * str, const char * str_end, char c);
char * imgui_i_im_strdup(ImGuiContext *imgui_c89_ctx, const char * str);
char * imgui_i_im_strdupcpy(ImGuiContext *imgui_c89_ctx, char * dst, size_t * p_dst_size, const char * src);
const char * imgui_i_im_streol_range(const char * str, const char * str_end);
int imgui_i_im_stricmp(const char * str1, const char * str2);
const char * imgui_i_im_stristr(const char * haystack, const char * haystack_end, const char * needle, const char * needle_end);
int imgui_i_im_strlen_w(const ImWchar * str);
void imgui_i_im_strncpy(char * dst, const char * src, size_t count);
int imgui_i_im_strnicmp(const char * str1, const char * str2, size_t count);
...
int imgui_i_im_text_char_from_utf8(unsigned int * out_char, const char * in_text, const char * in_text_end);
int imgui_i_im_text_char_to_utf8(char * out_buf, unsigned int c);
...
int imgui_i_im_text_count_chars_from_utf8(const char * in_text, const char * in_text_end);
int imgui_i_im_text_count_lines(const char * in_text, const char * in_text_end);
int imgui_i_im_text_count_utf8_bytes_from_char(const char * in_text, const char * in_text_end);
int imgui_i_im_text_count_utf8_bytes_from_str(const ImWchar * in_text, const ImWchar * in_text_end);
const char * imgui_i_im_text_find_previous_utf8_codepoint(const char * in_text_start, const char * in_p);
const char * imgui_i_im_text_find_valid_utf8_codepoint_end(const char * in_text_start, const char * in_text_end, const char * in_p);
void imgui_i_im_text_init_classifiers(void);
int imgui_i_im_text_str_from_utf8(ImWchar * buf, int buf_size, const char * in_text, const char * in_text_end, const char ** in_text_remaining);
int imgui_i_im_text_str_to_utf8(char * out_buf, int out_buf_size, const ImWchar * in_text, const ImWchar * in_text_end);
...
void imgui_i_im_triangle_barycentric_coords(const ImVec2 * a, const ImVec2 * b, const ImVec2 * c, const ImVec2 * p, float * out_u, float * out_v, float * out_w);
ImVec2 imgui_i_im_triangle_closest_point(const ImVec2 * a, const ImVec2 * b, const ImVec2 * c, const ImVec2 * p);
unsigned char imgui_i_im_triangle_contains_point(const ImVec2 * a, const ImVec2 * b, const ImVec2 * c, const ImVec2 * p);
...
void imgui_i_im_gui_activate_item_by_id(ImGuiContext *imgui_c89_ctx, ImGuiID id);
ImGuiID imgui_i_im_gui_add_context_hook(ImGuiContext *imgui_c89_ctx, ImGuiContext * ctx, const ImGuiContextHook * hook);
void imgui_i_im_gui_add_draw_list_to_draw_data_ex(ImGuiContext *imgui_c89_ctx, ImDrawData * draw_data, ImVector_ImDrawList_ptr * out_list, ImDrawList * draw_list);
void imgui_i_im_gui_add_settings_handler(ImGuiContext *imgui_c89_ctx, const ImGuiSettingsHandler * handler);
...
unsigned char imgui_i_im_gui_begin_child_ex(ImGuiContext *imgui_c89_ctx, const char * name, ImGuiID id, const ImVec2 * size_arg, ImGuiChildFlags child_flags, ImGuiWindowFlags window_flags);
void imgui_i_im_gui_begin_columns(ImGuiContext *imgui_c89_ctx, const char * str_id, int columns_count, ImGuiOldColumnFlags flags);
...
void imgui_i_im_gui_begin_disabled_override_reenable(ImGuiContext *imgui_c89_ctx);
unsigned char imgui_i_im_gui_begin_drag_drop_target_custom(ImGuiContext *imgui_c89_ctx, const ImRect * bb, ImGuiID id);
unsigned char imgui_i_im_gui_begin_drag_drop_target_viewport(ImGuiContext *imgui_c89_ctx, ImGuiViewport * viewport, const ImRect * p_bb);
unsigned char imgui_i_im_gui_begin_error_tooltip(ImGuiContext *imgui_c89_ctx);
...
unsigned char imgui_i_im_gui_begin_popup_ex(ImGuiContext *imgui_c89_ctx, ImGuiID id, ImGuiWindowFlags extra_window_flags);
unsigned char imgui_i_im_gui_begin_popup_menu_ex(ImGuiContext *imgui_c89_ctx, ImGuiID id, const char * label, ImGuiWindowFlags extra_window_flags);
...
unsigned char imgui_i_im_gui_begin_table_ex(ImGuiContext *imgui_c89_ctx, const char * name, ImGuiID id, int columns_count, ImGuiTableFlags flags, const ImVec2 * outer_size, float inner_width);
unsigned char imgui_i_im_gui_begin_tooltip_ex(ImGuiContext *imgui_c89_ctx, ImGuiTooltipFlags tooltip_flags, ImGuiWindowFlags extra_window_flags);
unsigned char imgui_i_im_gui_begin_tooltip_hidden(ImGuiContext *imgui_c89_ctx);
...
void imgui_i_im_gui_bring_window_to_display_back(ImGuiContext *imgui_c89_ctx, ImGuiWindow * window);
void imgui_i_im_gui_bring_window_to_display_behind(ImGuiContext *imgui_c89_ctx, ImGuiWindow * window, ImGuiWindow * behind_window);
void imgui_i_im_gui_bring_window_to_display_front(ImGuiContext *imgui_c89_ctx, ImGuiWindow * window);
void imgui_i_im_gui_bring_window_to_focus_front(ImGuiContext *imgui_c89_ctx, ImGuiWindow * window);
...
void imgui_i_im_gui_calc_clip_rect_visible_items_y(const ImRect * clip_rect, const ImVec2 * pos, float items_height, int * out_visible_start, int * out_visible_end);
ImVec2 imgui_i_im_gui_calc_item_size(ImGuiContext *imgui_c89_ctx, ImVec2 size, float default_w, float default_h);
ImDrawFlags imgui_i_im_gui_calc_rounding_flags_for_rect_in_rect(const ImRect * r_in, const ImRect * r_outer, float threshold);
int imgui_i_im_gui_calc_typematic_repeat_amount(float t0, float t1, float repeat_delay, float repeat_rate);
ImVec2 imgui_i_im_gui_calc_window_next_auto_fit_size(ImGuiContext *imgui_c89_ctx, ImGuiWindow * window);
float imgui_i_im_gui_calc_wrap_width_for_pos(ImGuiContext *imgui_c89_ctx, const ImVec2 * pos, float wrap_pos_x);
void imgui_i_im_gui_call_context_hooks(ImGuiContext * ctx, ImGuiContextHookType hook_type);
...
void imgui_i_im_gui_cleanup_ini_settings(ImGuiContext *imgui_c89_ctx, ImGuiSettingsCleanupArgs * args);
void imgui_i_im_gui_clear_active_id(ImGuiContext *imgui_c89_ctx);
void imgui_i_im_gui_clear_drag_drop(ImGuiContext *imgui_c89_ctx);
void imgui_i_im_gui_clear_ini_settings(ImGuiContext *imgui_c89_ctx);
void imgui_i_im_gui_clear_window_settings(ImGuiContext *imgui_c89_ctx, const char * name);
unsigned char imgui_i_im_gui_close_button(ImGuiContext *imgui_c89_ctx, ImGuiID id, const ImVec2 * pos);
void imgui_i_im_gui_close_popup_to_level(ImGuiContext *imgui_c89_ctx, int remaining, unsigned char restore_focus_to_window_under_popup);
void imgui_i_im_gui_close_popups_except_modals(ImGuiContext *imgui_c89_ctx);
void imgui_i_im_gui_close_popups_over_window(ImGuiContext *imgui_c89_ctx, ImGuiWindow * ref_window, unsigned char restore_focus_to_window_under_popup);
...
ImGuiWindowSettings * imgui_i_im_gui_create_new_window_settings(ImGuiContext *imgui_c89_ctx, const char * name);
...
void imgui_i_im_gui_debug_alloc_hook(ImGuiDebugAllocInfo * info, int frame_count, void * ptr, size_t size);
unsigned char imgui_i_im_gui_debug_break_button(ImGuiContext *imgui_c89_ctx, const char * label, const char * description_of_location);
void imgui_i_im_gui_debug_break_button_tooltip(ImGuiContext *imgui_c89_ctx, unsigned char keyboard_only, const char * description_of_location);
void imgui_i_im_gui_debug_break_clear_data(ImGuiContext *imgui_c89_ctx);
void imgui_i_im_gui_debug_draw_cursor_pos(ImGuiContext *imgui_c89_ctx, ImU32 col);
void imgui_i_im_gui_debug_draw_item_rect(ImGuiContext *imgui_c89_ctx, ImU32 col);
void imgui_i_im_gui_debug_draw_line_extents(ImGuiContext *imgui_c89_ctx, ImU32 col);
void imgui_i_im_gui_debug_hook_id_info(ImGuiContext *imgui_c89_ctx, ImGuiID id, ImGuiDataType data_type, const void * data_id, const void * data_id_end);
void imgui_i_im_gui_debug_locate_item(ImGuiContext *imgui_c89_ctx, ImGuiID target_id);
void imgui_i_im_gui_debug_locate_item_on_hover(ImGuiContext *imgui_c89_ctx, ImGuiID target_id);
void imgui_i_im_gui_debug_locate_item_resolve_with_last_item(ImGuiContext *imgui_c89_ctx);
void imgui_i_im_gui_debug_log(ImGuiContext *imgui_c89_ctx, const char * fmt, ...);
void imgui_i_im_gui_debug_node_columns(ImGuiContext *imgui_c89_ctx, ImGuiOldColumns * columns);
void imgui_i_im_gui_debug_node_draw_cmd_show_mesh_and_bounding_box(ImGuiContext *imgui_c89_ctx, ImDrawList * out_draw_list, const ImDrawList * draw_list, const ImDrawCmd * draw_cmd, unsigned char show_mesh, unsigned char show_aabb);
void imgui_i_im_gui_debug_node_draw_list(ImGuiContext *imgui_c89_ctx, ImGuiWindow * window, ImGuiViewportP * viewport, const ImDrawList * draw_list, const char * label);
void imgui_i_im_gui_debug_node_font(ImGuiContext *imgui_c89_ctx, ImFont * font);
void imgui_i_im_gui_debug_node_font_glyph(ImGuiContext *imgui_c89_ctx, ImFont * font, const ImFontGlyph * glyph);
void imgui_i_im_gui_debug_node_font_glyphs_for_src_mask(ImGuiContext *imgui_c89_ctx, ImFont * font, ImFontBaked * baked, int src_mask);
...
void imgui_i_im_gui_debug_node_storage(ImGuiContext *imgui_c89_ctx, ImGuiStorage * storage, const char * label);
void imgui_i_im_gui_debug_node_tab_bar(ImGuiContext *imgui_c89_ctx, ImGuiTabBar * tab_bar, const char * label);
void imgui_i_im_gui_debug_node_table(ImGuiContext *imgui_c89_ctx, ImGuiTable * table);
void imgui_i_im_gui_debug_node_table_settings(ImGuiContext *imgui_c89_ctx, ImGuiTableSettings * settings, ImGuiTable * table);
void imgui_i_im_gui_debug_node_texture(ImGuiContext *imgui_c89_ctx, ImTextureData * tex, int int_id, const ImFontAtlasRect * highlight_rect);
void imgui_i_im_gui_debug_node_typing_select_state(ImGuiContext *imgui_c89_ctx, ImGuiTypingSelectState * data);
void imgui_i_im_gui_debug_node_viewport(ImGuiContext *imgui_c89_ctx, ImGuiViewportP * viewport);
void imgui_i_im_gui_debug_node_window(ImGuiContext *imgui_c89_ctx, ImGuiWindow * window, const char * label);
void imgui_i_im_gui_debug_node_window_settings(ImGuiContext *imgui_c89_ctx, ImGuiWindowSettings * settings);
void imgui_i_im_gui_debug_node_windows_list(ImGuiContext *imgui_c89_ctx, ImVector_ImGuiWindow_ptr * windows, const char * label);
void imgui_i_im_gui_debug_node_windows_list_by_begin_stack_parent(ImGuiContext *imgui_c89_ctx, ImGuiWindow ** windows, int windows_size, ImGuiWindow * parent_in_begin_stack);
void imgui_i_im_gui_debug_render_keyboard_preview(ImGuiContext *imgui_c89_ctx, ImDrawList * draw_list);
void imgui_i_im_gui_debug_render_viewport_thumbnail(ImGuiContext *imgui_c89_ctx, ImDrawList * draw_list, ImGuiViewportP * viewport, const ImRect * bb);
void imgui_i_im_gui_debug_text_unformatted_with_locate_item(ImGuiContext *imgui_c89_ctx, const char * line_begin, const char * line_end);
ImU64 imgui_i_im_gui_debug_texture_id_to_u64(ImTextureID tex_id);
void imgui_i_im_gui_demo_marker(ImGuiContext *imgui_c89_ctx, const char * file, int line, const char * section);
...
void imgui_i_im_gui_end_columns(ImGuiContext *imgui_c89_ctx);
void imgui_i_im_gui_end_combo_preview(ImGuiContext *imgui_c89_ctx);
void imgui_i_im_gui_end_disabled_override_reenable(ImGuiContext *imgui_c89_ctx);
void imgui_i_im_gui_end_error_tooltip(ImGuiContext *imgui_c89_ctx);
void imgui_i_im_gui_error_check_end_frame_finalize_error_tooltip(ImGuiContext *imgui_c89_ctx);
void imgui_i_im_gui_error_check_using_set_cursor_pos_to_extend_parent_boundaries(ImGuiContext *imgui_c89_ctx);
unsigned char imgui_i_im_gui_error_log(ImGuiContext *imgui_c89_ctx, const char * msg);
void imgui_i_im_gui_error_recovery_store_state(ImGuiContext *imgui_c89_ctx, ImGuiErrorRecoveryState * state_out);
void imgui_i_im_gui_error_recovery_try_to_recover_state(ImGuiContext *imgui_c89_ctx, const ImGuiErrorRecoveryState * state_in);
void imgui_i_im_gui_error_recovery_try_to_recover_window_state(ImGuiContext *imgui_c89_ctx, const ImGuiErrorRecoveryState * state_in);
void imgui_i_im_gui_extend_hit_box_when_near_viewport_edge(ImGuiWindow * window, ImRect * bb, float threshold, ImGuiAxis axis);
ImVec2 imgui_i_im_gui_find_best_window_pos_for_popup(ImGuiContext *imgui_c89_ctx, ImGuiWindow * window);
ImVec2 imgui_i_im_gui_find_best_window_pos_for_popup_ex(const ImVec2 * ref_pos, const ImVec2 * size, ImGuiDir * last_dir, const ImRect * r_outer, const ImRect * r_avoid, ImGuiPopupPositionPolicy policy);
ImGuiWindow * imgui_i_im_gui_find_blocking_modal(ImGuiContext *imgui_c89_ctx, ImGuiWindow * window);
ImGuiWindow * imgui_i_im_gui_find_bottom_most_visible_window_within_begin_stack(ImGuiContext *imgui_c89_ctx, ImGuiWindow * parent_window);
ImGuiWindow * imgui_i_im_gui_find_front_most_visible_child_window(ImGuiWindow * window);
void imgui_i_im_gui_find_hovered_window_ex(ImGuiContext *imgui_c89_ctx, const ImVec2 * pos, unsigned char find_first_and_in_any_viewport, ImGuiWindow ** out_hovered_window, ImGuiWindow ** out_hovered_window_under_moving_window);
ImGuiOldColumns * imgui_i_im_gui_find_or_create_columns(ImGuiContext *imgui_c89_ctx, ImGuiWindow * window, ImGuiID id);
const char * imgui_i_im_gui_find_rendered_text_end(const char * text, const char * text_end);
ImGuiSettingsHandler * imgui_i_im_gui_find_settings_handler(ImGuiContext *imgui_c89_ctx, const char * type_name);
ImGuiWindow * imgui_i_im_gui_find_window_by_id(ImGuiContext *imgui_c89_ctx, ImGuiID id);
ImGuiWindow * imgui_i_im_gui_find_window_by_name(ImGuiContext *imgui_c89_ctx, const char * name);
int imgui_i_im_gui_find_window_display_index(ImGuiContext *imgui_c89_ctx, ImGuiWindow * window);
ImGuiWindowSettings * imgui_i_im_gui_find_window_settings_by_id(ImGuiContext *imgui_c89_ctx, ImGuiID id);
ImGuiWindowSettings * imgui_i_im_gui_find_window_settings_by_window(ImGuiContext *imgui_c89_ctx, ImGuiWindow * window);
ImGuiKeyChord imgui_i_im_gui_fixup_key_chord(ImGuiKeyChord key_chord);
void imgui_i_im_gui_focus_item(ImGuiContext *imgui_c89_ctx);
void imgui_i_im_gui_focus_top_most_window_under_one(ImGuiContext *imgui_c89_ctx, ImGuiWindow * under_this_window, ImGuiWindow * ignore_window, ImGuiViewport * filter_viewport, ImGuiFocusRequestFlags flags);
void imgui_i_im_gui_focus_window(ImGuiContext *imgui_c89_ctx, ImGuiWindow * window, ImGuiFocusRequestFlags flags);
void imgui_i_im_gui_gc_awake_transient_window_buffers(ImGuiContext *imgui_c89_ctx, ImGuiWindow * window);
void imgui_i_im_gui_gc_compact_transient_misc_buffers(ImGuiContext *imgui_c89_ctx);
void imgui_i_im_gui_gc_compact_transient_window_buffers(ImGuiContext *imgui_c89_ctx, ImGuiWindow * window);
ImDrawList * imgui_i_im_gui_get_background_draw_list(ImGuiContext *imgui_c89_ctx, ImGuiViewport * viewport);
ImGuiBoxSelectState * ImGui_GetBoxSelectState__9b73c23d2f(ImGuiContext *imgui_c89_ctx, ImGuiID id);
float imgui_i_im_gui_get_column_norm_from_offset(const ImGuiOldColumns * columns, float offset);
float imgui_i_im_gui_get_column_offset_from_norm(const ImGuiOldColumns * columns, float offset_norm);
ImGuiID imgui_i_im_gui_get_columns_id(ImGuiContext *imgui_c89_ctx, const char * str_id, int columns_count);
ImGuiWindow * ImGui_GetCurrentWindow__f542a96313(ImGuiContext *imgui_c89_ctx);
ImGuiWindow * ImGui_GetCurrentWindowRead__c7df9c532e(ImGuiContext *imgui_c89_ctx);
ImFont * imgui_i_im_gui_get_default_font(ImGuiContext *imgui_c89_ctx);
ImDrawList * imgui_i_im_gui_get_foreground_draw_list(ImGuiContext *imgui_c89_ctx, ImGuiViewport * viewport);
ImDrawList * ImGui_GetForegroundDrawList__167528742e(ImGuiContext *imgui_c89_ctx, ImGuiWindow * window);
ImGuiID imgui_i_im_gui_get_hovered_id(ImGuiContext *imgui_c89_ctx);
ImGuiID imgui_i_im_gui_get_id_with_seed_string_string_id(ImGuiContext *imgui_c89_ctx, const char * str, const char * str_end, ImGuiID seed);
ImGuiID imgui_i_im_gui_get_id_with_seed_int_id(ImGuiContext *imgui_c89_ctx, int n, ImGuiID seed);
ImGuiIO * imgui_i_im_gui_get_io(ImGuiContext * ctx);
ImGuiInputTextState * ImGui_GetInputTextState__1cf253e65e(ImGuiContext *imgui_c89_ctx, ImGuiID id);
const char * imgui_i_im_gui_get_key_chord_name(ImGuiContext *imgui_c89_ctx, ImGuiKeyChord key_chord);
ImGuiKeyData * ImGui_GetKeyData__35ffe023d5(ImGuiContext *imgui_c89_ctx, ImGuiKey key);
ImGuiKeyData * imgui_i_im_gui_get_key_data(ImGuiContext * ctx, ImGuiKey key);
ImVec2 imgui_i_im_gui_get_key_magnitude2d(ImGuiContext *imgui_c89_ctx, ImGuiKey key_left, ImGuiKey key_right, ImGuiKey key_up, ImGuiKey key_down);
ImGuiID imgui_i_im_gui_get_key_owner(ImGuiContext *imgui_c89_ctx, ImGuiKey key);
ImGuiMouseButton imgui_i_im_gui_get_mouse_button_from_popup_flags(ImGuiPopupFlags flags);
float imgui_i_im_gui_get_nav_tweak_pressed_amount(ImGuiContext *imgui_c89_ctx, ImGuiAxis axis);
ImGuiPlatformIO * imgui_i_im_gui_get_platform_io(ImGuiContext * ctx);
ImRect imgui_i_im_gui_get_popup_allowed_extent_rect(ImGuiContext *imgui_c89_ctx, ImGuiWindow * window);
float ImGui_GetRoundedFontSize__822dc3c5f9(float size);
ImGuiKeyRoutingData * imgui_i_im_gui_get_shortcut_routing_data(ImGuiContext *imgui_c89_ctx, ImGuiKeyChord key_chord);
const ImGuiStyleVarInfo * imgui_i_im_gui_get_style_var_info(ImGuiStyleVar idx);
ImGuiWindow * imgui_i_im_gui_get_top_most_and_visible_popup_modal(ImGuiContext *imgui_c89_ctx);
ImGuiWindow * imgui_i_im_gui_get_top_most_popup_modal(ImGuiContext *imgui_c89_ctx);
void imgui_i_im_gui_get_typematic_repeat_rate(ImGuiContext *imgui_c89_ctx, ImGuiInputFlags flags, float * repeat_delay, float * repeat_rate);
...
ImGuiID imgui_i_im_gui_get_window_resize_border_id(ImGuiWindow * window, ImGuiDir dir);
ImGuiID imgui_i_im_gui_get_window_resize_corner_id(ImGuiWindow * window, int n);
...
void imgui_i_im_gui_initialize(ImGuiContext *imgui_c89_ctx);
...
unsigned char imgui_i_im_gui_is_clipped_ex(ImGuiContext *imgui_c89_ctx, const ImRect * bb, ImGuiID id);
unsigned char imgui_i_im_gui_is_drag_drop_active(ImGuiContext *imgui_c89_ctx);
unsigned char imgui_i_im_gui_is_drag_drop_payload_being_accepted(ImGuiContext *imgui_c89_ctx);
unsigned char imgui_i_im_gui_is_in_nav_focus_route(ImGuiContext *imgui_c89_ctx, ImGuiID focus_scope_id);
unsigned char imgui_i_im_gui_is_key_chord_pressed(ImGuiContext *imgui_c89_ctx, ImGuiKeyChord key_chord, ImGuiInputFlags flags, ImGuiID owner_id);
unsigned char imgui_i_im_gui_is_key_down(ImGuiContext *imgui_c89_ctx, ImGuiKey key, ImGuiID owner_id);
unsigned char imgui_i_im_gui_is_key_pressed(ImGuiContext *imgui_c89_ctx, ImGuiKey key, ImGuiInputFlags flags, ImGuiID owner_id);
unsigned char imgui_i_im_gui_is_key_released(ImGuiContext *imgui_c89_ctx, ImGuiKey key, ImGuiID owner_id);
unsigned char imgui_i_im_gui_is_mouse_clicked(ImGuiContext *imgui_c89_ctx, ImGuiMouseButton button, ImGuiInputFlags flags, ImGuiID owner_id);
unsigned char imgui_i_im_gui_is_mouse_double_clicked(ImGuiContext *imgui_c89_ctx, ImGuiMouseButton button, ImGuiID owner_id);
unsigned char imgui_i_im_gui_is_mouse_down(ImGuiContext *imgui_c89_ctx, ImGuiMouseButton button, ImGuiID owner_id);
unsigned char imgui_i_im_gui_is_mouse_drag_past_threshold(ImGuiContext *imgui_c89_ctx, ImGuiMouseButton button, float lock_threshold);
unsigned char imgui_i_im_gui_is_mouse_released(ImGuiContext *imgui_c89_ctx, ImGuiMouseButton button, ImGuiID owner_id);
unsigned char imgui_i_im_gui_is_popup_open(ImGuiContext *imgui_c89_ctx, ImGuiID id, ImGuiPopupFlags popup_flags);
unsigned char imgui_i_im_gui_is_popup_open_request_for_item(ImGuiContext *imgui_c89_ctx, ImGuiPopupFlags popup_flags, ImGuiID id);
unsigned char imgui_i_im_gui_is_popup_open_request_for_window(ImGuiContext *imgui_c89_ctx, ImGuiPopupFlags popup_flags);
unsigned char imgui_i_im_gui_is_window_above(ImGuiContext *imgui_c89_ctx, ImGuiWindow * potential_above, ImGuiWindow * potential_below);
unsigned char imgui_i_im_gui_is_window_child_of(ImGuiWindow * window, ImGuiWindow * potential_parent, unsigned char popup_hierarchy);
unsigned char imgui_i_im_gui_is_window_content_hoverable(ImGuiContext *imgui_c89_ctx, ImGuiWindow * window, ImGuiHoveredFlags flags);
unsigned char imgui_i_im_gui_is_window_in_begin_stack(ImGuiContext *imgui_c89_ctx, ImGuiWindow * window);
unsigned char imgui_i_im_gui_is_window_nav_focusable(ImGuiWindow * window);
unsigned char imgui_i_im_gui_is_window_within_begin_stack_of(ImGuiWindow * window, ImGuiWindow * potential_parent);
unsigned char imgui_i_im_gui_item_add(ImGuiContext *imgui_c89_ctx, const ImRect * bb, ImGuiID id, const ImRect * nav_bb_arg, ImGuiItemFlags extra_flags);
unsigned char imgui_i_im_gui_item_hoverable(ImGuiContext *imgui_c89_ctx, const ImRect * bb, ImGuiID id, ImGuiItemFlags item_flags);
void ImGui_ItemSize__8033f34120(ImGuiContext *imgui_c89_ctx, const ImRect * bb, float text_baseline_y);
void imgui_i_im_gui_item_size(ImGuiContext *imgui_c89_ctx, const ImVec2 * size, float text_baseline_y);
void imgui_i_im_gui_keep_alive_id(ImGuiContext *imgui_c89_ctx, ImGuiID id);
...
void imgui_i_im_gui_localize_register_entries(ImGuiContext *imgui_c89_ctx, const ImGuiLocEntry * entries, int count);
void imgui_i_im_gui_log_begin(ImGuiContext *imgui_c89_ctx, ImGuiLogFlags flags, int auto_open_depth);
void imgui_i_im_gui_log_rendered_text(ImGuiContext *imgui_c89_ctx, const ImVec2 * ref_pos, const char * text, const char * text_end);
void imgui_i_im_gui_log_set_next_text_decoration(ImGuiContext *imgui_c89_ctx, const char * prefix, const char * suffix);
void imgui_i_im_gui_log_text(ImGuiContext *imgui_c89_ctx, const char * fmt, ...);
void imgui_i_im_gui_log_to_buffer(ImGuiContext *imgui_c89_ctx, int auto_open_depth);
void imgui_i_im_gui_mark_ini_settings_dirty_void(ImGuiContext *imgui_c89_ctx);
void imgui_i_im_gui_mark_ini_settings_dirty_window_pointer(ImGuiContext *imgui_c89_ctx, ImGuiWindow * window);
void imgui_i_im_gui_mark_item_edited(ImGuiContext *imgui_c89_ctx, ImGuiID id);
...
void imgui_i_im_gui_nav_clear_preferred_pos_for_axis(ImGuiContext *imgui_c89_ctx, ImGuiAxis axis);
void imgui_i_im_gui_nav_highlight_activated(ImGuiContext *imgui_c89_ctx, ImGuiID id);
void imgui_i_im_gui_nav_init_request_apply_result(ImGuiContext *imgui_c89_ctx);
void imgui_i_im_gui_nav_init_window(ImGuiContext *imgui_c89_ctx, ImGuiWindow * window, unsigned char force_reinit);
void imgui_i_im_gui_nav_move_request_apply_result(ImGuiContext *imgui_c89_ctx);
unsigned char imgui_i_im_gui_nav_move_request_but_no_result_yet(ImGuiContext *imgui_c89_ctx);
void imgui_i_im_gui_nav_move_request_cancel(ImGuiContext *imgui_c89_ctx);
void imgui_i_im_gui_nav_move_request_forward(ImGuiContext *imgui_c89_ctx, ImGuiDir move_dir, ImGuiDir clip_dir, ImGuiNavMoveFlags move_flags, ImGuiScrollFlags scroll_flags);
void imgui_i_im_gui_nav_move_request_resolve_with_last_item(ImGuiContext *imgui_c89_ctx, ImGuiNavItemData * result);
void imgui_i_im_gui_nav_move_request_resolve_with_past_tree_node(ImGuiContext *imgui_c89_ctx, ImGuiNavItemData * result, const ImGuiTreeNodeStackData * tree_node_data);
void imgui_i_im_gui_nav_move_request_submit(ImGuiContext *imgui_c89_ctx, ImGuiDir move_dir, ImGuiDir clip_dir, ImGuiNavMoveFlags move_flags, ImGuiScrollFlags scroll_flags);
void imgui_i_im_gui_nav_move_request_try_wrapping(ImGuiContext *imgui_c89_ctx, ImGuiWindow * window, ImGuiNavMoveFlags wrap_flags);
void imgui_i_im_gui_nav_update_current_window_is_scroll_pushable_x(ImGuiContext *imgui_c89_ctx);
unsigned char imgui_i_im_gui_open_popup_ex(ImGuiContext *imgui_c89_ctx, ImGuiID id, ImGuiPopupFlags popup_flags);
...
void imgui_i_im_gui_pop_columns_background(ImGuiContext *imgui_c89_ctx);
void imgui_i_im_gui_pop_focus_scope(ImGuiContext *imgui_c89_ctx);
void imgui_i_im_gui_pop_password_font(ImGuiContext *imgui_c89_ctx);
void imgui_i_im_gui_push_column_clip_rect(ImGuiContext *imgui_c89_ctx, int column_index);
void imgui_i_im_gui_push_columns_background(ImGuiContext *imgui_c89_ctx);
void imgui_i_im_gui_push_focus_scope(ImGuiContext *imgui_c89_ctx, ImGuiID id);
void imgui_i_im_gui_push_multi_items_widths(ImGuiContext *imgui_c89_ctx, int components, float w_full);
void imgui_i_im_gui_push_override_id(ImGuiContext *imgui_c89_ctx, ImGuiID id);
void imgui_i_im_gui_push_password_font(ImGuiContext *imgui_c89_ctx);
void imgui_i_im_gui_register_font_atlas(ImGuiContext *imgui_c89_ctx, ImFontAtlas * atlas);
void imgui_i_im_gui_register_user_texture(ImGuiContext *imgui_c89_ctx, ImTextureData * tex);
void imgui_i_im_gui_remove_context_hook(ImGuiContext * ctx, ImGuiID hook_id);
void imgui_i_im_gui_remove_settings_handler(ImGuiContext *imgui_c89_ctx, const char * type_name);
void imgui_i_im_gui_render_arrow(ImGuiContext *imgui_c89_ctx, ImDrawList * draw_list, ImVec2 pos, ImU32 col, ImGuiDir dir, float scale);
void imgui_i_im_gui_render_arrow_pointing_at(ImGuiContext *imgui_c89_ctx, ImDrawList * draw_list, ImVec2 pos, ImVec2 half_sz, ImGuiDir direction, ImU32 col);
void imgui_i_im_gui_render_bullet(ImGuiContext *imgui_c89_ctx, ImDrawList * draw_list, ImVec2 pos, ImU32 col);
void imgui_i_im_gui_render_check_mark(ImGuiContext *imgui_c89_ctx, ImDrawList * draw_list, ImVec2 pos, ImU32 col, float sz);
void imgui_i_im_gui_render_color_component_marker(ImGuiContext *imgui_c89_ctx, const ImRect * bb, ImU32 col, float rounding);
void imgui_i_im_gui_render_color_rect_with_alpha_checkerboard(ImGuiContext *imgui_c89_ctx, ImDrawList * draw_list, ImVec2 p_min, ImVec2 p_max, ImU32 col, float grid_step, ImVec2 grid_off, float rounding, ImDrawFlags flags);
void imgui_i_im_gui_render_drag_drop_target_rect_ex(ImGuiContext *imgui_c89_ctx, ImDrawList * draw_list, const ImRect * bb, float rounding);
void imgui_i_im_gui_render_drag_drop_target_rect_for_item(ImGuiContext *imgui_c89_ctx, const ImRect * bb);
void imgui_i_im_gui_render_frame(ImGuiContext *imgui_c89_ctx, ImVec2 p_min, ImVec2 p_max, ImU32 fill_col, unsigned char borders, float rounding);
void imgui_i_im_gui_render_frame_border(ImGuiContext *imgui_c89_ctx, ImVec2 p_min, ImVec2 p_max, float rounding);
void imgui_i_im_gui_render_mouse_cursor(ImGuiContext *imgui_c89_ctx, ImVec2 base_pos, float base_scale, ImGuiMouseCursor mouse_cursor, ImU32 col_fill, ImU32 col_border, ImU32 col_shadow);
void imgui_i_im_gui_render_nav_cursor(ImGuiContext *imgui_c89_ctx, const ImRect * bb, ImGuiID id, ImGuiNavRenderCursorFlags flags, float rounding);
void imgui_i_im_gui_render_rect_filled_in_range_h(ImGuiContext *imgui_c89_ctx, ImDrawList * draw_list, const ImRect * rect, ImU32 col, float fill_x0, float fill_x1, float rounding);
void imgui_i_im_gui_render_rect_filled_with_hole(ImGuiContext *imgui_c89_ctx, ImDrawList * draw_list, const ImRect * outer, const ImRect * inner, ImU32 col, float rounding);
void imgui_i_im_gui_render_text(ImGuiContext *imgui_c89_ctx, ImVec2 pos, const char * text, const char * text_end, unsigned char hide_text_after_hash);
void imgui_i_im_gui_render_text_clipped(ImGuiContext *imgui_c89_ctx, const ImVec2 * pos_min, const ImVec2 * pos_max, const char * text, const char * text_end, const ImVec2 * text_size_if_known, const ImVec2 * align, const ImRect * clip_rect);
void imgui_i_im_gui_render_text_clipped_ex(ImGuiContext *imgui_c89_ctx, ImDrawList * draw_list, const ImVec2 * pos_min, const ImVec2 * pos_max, const char * text, const char * text_display_end, const ImVec2 * text_size_if_known, const ImVec2 * align, const ImRect * clip_rect);
void imgui_i_im_gui_render_text_ellipsis(ImGuiContext *imgui_c89_ctx, ImDrawList * draw_list, const ImVec2 * pos_min, const ImVec2 * pos_max, float ellipsis_max_x, const char * text, const char * text_end_full, const ImVec2 * text_size_if_known);
void imgui_i_im_gui_render_text_wrapped(ImGuiContext *imgui_c89_ctx, ImVec2 pos, const char * text, const char * text_end, float wrap_width);
void imgui_i_im_gui_scale_windows_in_viewport(ImGuiContext *imgui_c89_ctx, ImGuiViewportP * viewport, float scale);
void imgui_i_im_gui_scroll_to_item(ImGuiContext *imgui_c89_ctx, ImGuiScrollFlags flags);
void imgui_i_im_gui_scroll_to_rect(ImGuiContext *imgui_c89_ctx, ImGuiWindow * window, const ImRect * item_rect, ImGuiScrollFlags flags);
ImVec2 imgui_i_im_gui_scroll_to_rect_ex(ImGuiContext *imgui_c89_ctx, ImGuiWindow * window, const ImRect * item_rect, ImGuiScrollFlags flags);
...
void imgui_i_im_gui_set_active_id(ImGuiContext *imgui_c89_ctx, ImGuiID id, ImGuiWindow * window);
void imgui_i_im_gui_set_active_id_using_all_keyboard_keys(ImGuiContext *imgui_c89_ctx);
void imgui_i_im_gui_set_context_name(ImGuiContext * ctx, const char * name);
void imgui_i_im_gui_set_current_font(ImGuiContext *imgui_c89_ctx, ImFont * font, float font_size_before_scaling, float font_size_after_scaling);
void imgui_i_im_gui_set_focus_id(ImGuiContext *imgui_c89_ctx, ImGuiID id, ImGuiWindow * window);
void imgui_i_im_gui_set_font_rasterizer_density(ImGuiContext *imgui_c89_ctx, float rasterizer_density);
void imgui_i_im_gui_set_hovered_id(ImGuiContext *imgui_c89_ctx, ImGuiID id);
unsigned char imgui_i_im_gui_set_item_key_owner(ImGuiContext *imgui_c89_ctx, ImGuiKey key, ImGuiInputFlags flags);
void imgui_i_im_gui_set_item_tooltip(ImGuiContext *imgui_c89_ctx, const char * fmt, ...);
void imgui_i_im_gui_set_key_owner(ImGuiContext *imgui_c89_ctx, ImGuiKey key, ImGuiID owner_id, ImGuiInputFlags flags);
void imgui_i_im_gui_set_key_owners_for_key_chord(ImGuiContext *imgui_c89_ctx, ImGuiKeyChord key_chord, ImGuiID owner_id, ImGuiInputFlags flags);
void imgui_i_im_gui_set_last_item_data(ImGuiContext *imgui_c89_ctx, ImGuiID item_id, ImGuiItemFlags item_flags, ImGuiItemStatusFlags status_flags, const ImRect * item_rect);
void imgui_i_im_gui_set_nav_cursor_visible_after_move(ImGuiContext *imgui_c89_ctx);
void imgui_i_im_gui_set_nav_focus_scope(ImGuiContext *imgui_c89_ctx, ImGuiID focus_scope_id);
void imgui_i_im_gui_set_nav_id(ImGuiContext *imgui_c89_ctx, ImGuiID id, ImGuiNavLayer nav_layer, ImGuiID focus_scope_id, const ImRect * rect_rel);
void imgui_i_im_gui_set_nav_window(ImGuiContext *imgui_c89_ctx, ImGuiWindow * window);
...
void imgui_i_im_gui_set_next_window_refresh_policy(ImGuiContext *imgui_c89_ctx, ImGuiWindowRefreshFlags flags);
void imgui_i_im_gui_set_scroll_from_pos_x(ImGuiWindow * window, float local_x, float center_x_ratio);
void imgui_i_im_gui_set_scroll_from_pos_y(ImGuiWindow * window, float local_y, float center_y_ratio);
void imgui_i_im_gui_set_scroll_x(ImGuiWindow * window, float scroll_x);
void imgui_i_im_gui_set_scroll_y(ImGuiWindow * window, float scroll_y);
unsigned char imgui_i_im_gui_set_shortcut_routing(ImGuiContext *imgui_c89_ctx, ImGuiKeyChord key_chord, ImGuiInputFlags flags, ImGuiID owner_id);
void imgui_i_im_gui_set_tooltip(ImGuiContext *imgui_c89_ctx, const char * fmt, ...);
void imgui_i_im_gui_set_window_clip_rect_before_set_channel(ImGuiWindow * window, const ImRect * clip_rect);
void imgui_i_im_gui_set_window_collapsed(ImGuiWindow * window, unsigned char collapsed, ImGuiCond cond);
void imgui_i_im_gui_set_window_hidden_and_skip_items_for_current_frame(ImGuiWindow * window);
void imgui_i_im_gui_set_window_hit_test_hole(ImGuiWindow * window, const ImVec2 * pos, const ImVec2 * size);
void imgui_i_im_gui_set_window_pos(ImGuiContext *imgui_c89_ctx, ImGuiWindow * window, const ImVec2 * pos, ImGuiCond cond);
void imgui_i_im_gui_set_window_size(ImGuiContext *imgui_c89_ctx, ImGuiWindow * window, const ImVec2 * size, ImGuiCond cond);
void imgui_i_im_gui_set_window_viewport(ImGuiWindow * window, ImGuiViewportP * viewport);
void imgui_i_im_gui_shade_verts_linear_color_gradient_keep_alpha(ImDrawList * draw_list, int vert_start_idx, int vert_end_idx, ImVec2 gradient_p0, ImVec2 gradient_p1, ImU32 col0, ImU32 col1);
void imgui_i_im_gui_shade_verts_linear_uv(ImDrawList * draw_list, int vert_start_idx, int vert_end_idx, const ImVec2 * a, const ImVec2 * b, const ImVec2 * uv_a, const ImVec2 * uv_b, unsigned char clamp);
void imgui_i_im_gui_shade_verts_transform_pos(ImDrawList * draw_list, int vert_start_idx, int vert_end_idx, const ImVec2 * pivot_in, float cos_a, float sin_a, const ImVec2 * pivot_out);
unsigned char imgui_i_im_gui_shortcut(ImGuiContext *imgui_c89_ctx, ImGuiKeyChord key_chord, ImGuiInputFlags flags, ImGuiID owner_id);
void ImGui_ShowAboutWindow__9333fde1e2(unsigned char * p_open);
void ImGui_ShowDemoWindow__f1609d4301(unsigned char * p_open);
void imgui_i_im_gui_show_font_atlas(ImGuiContext *imgui_c89_ctx, ImFontAtlas * atlas);
...
void imgui_i_im_gui_shutdown(ImGuiContext *imgui_c89_ctx);
...
void imgui_i_im_gui_start_mouse_moving_window(ImGuiContext *imgui_c89_ctx, ImGuiWindow * window);
void imgui_i_im_gui_stop_mouse_moving_window(ImGuiContext *imgui_c89_ctx);
...
void imgui_i_im_gui_table_angled_headers_row_ex(ImGuiContext *imgui_c89_ctx, ImGuiID row_id, float angle, float max_label_width, const ImGuiTableHeaderData * data, int data_count);
void imgui_i_im_gui_table_apply_external_unclip_rect(ImGuiTable * table, ImRect * rect);
void imgui_i_im_gui_table_apply_queued_requests(ImGuiContext *imgui_c89_ctx, ImGuiTable * table);
void imgui_i_im_gui_table_begin_cell(ImGuiContext *imgui_c89_ctx, ImGuiTable * table, int column_n);
unsigned char imgui_i_im_gui_table_begin_context_menu_popup(ImGuiContext *imgui_c89_ctx, ImGuiTable * table);
void imgui_i_im_gui_table_begin_init_memory(ImGuiContext *imgui_c89_ctx, ImGuiTable * table, int columns_count);
void imgui_i_im_gui_table_begin_row(ImGuiContext *imgui_c89_ctx, ImGuiTable * table);
float imgui_i_im_gui_table_calc_max_column_width(const ImGuiTable * table, int column_n);
void imgui_i_im_gui_table_draw_borders(ImGuiContext *imgui_c89_ctx, ImGuiTable * table);
void imgui_i_im_gui_table_draw_default_context_menu(ImGuiContext *imgui_c89_ctx, ImGuiTable * table, ImGuiTableFlags flags_for_section_to_display);
void imgui_i_im_gui_table_end_cell(ImGuiContext *imgui_c89_ctx, ImGuiTable * table);
void imgui_i_im_gui_table_end_row(ImGuiContext *imgui_c89_ctx, ImGuiTable * table);
ImGuiTable * imgui_i_im_gui_table_find_by_id(ImGuiContext *imgui_c89_ctx, ImGuiID id);
void imgui_i_im_gui_table_fix_column_sort_direction(ImGuiTable * table, ImGuiTableColumn * column);
void imgui_i_im_gui_table_fix_display_order(ImGuiContext *imgui_c89_ctx, ImGuiTable * table);
void imgui_i_im_gui_table_gc_compact_settings(ImGuiContext *imgui_c89_ctx);
void imgui_i_im_gui_table_gc_compact_transient_buffers_table_pointer(ImGuiContext *imgui_c89_ctx, ImGuiTable * table);
void imgui_i_im_gui_table_gc_compact_transient_buffers_table_temp_data_pointer(ImGuiContext *imgui_c89_ctx, ImGuiTableTempData * temp_data);
ImGuiTableSettings * imgui_i_im_gui_table_get_bound_settings(ImGuiContext *imgui_c89_ctx, ImGuiTable * table);
ImRect imgui_i_im_gui_table_get_cell_bg_rect(const ImGuiTable * table, int column_n);
const char * imgui_i_im_gui_table_get_column_name(const ImGuiTable * table, int column_n);
ImGuiSortDirection imgui_i_im_gui_table_get_column_next_sort_direction(ImGuiTableColumn * column);
ImGuiID imgui_i_im_gui_table_get_column_resize_id(ImGuiTable * table, int column_n, int instance_no);
float imgui_i_im_gui_table_get_column_width_auto(ImGuiTable * table, ImGuiTableColumn * column);
float imgui_i_im_gui_table_get_header_angled_max_label_width(ImGuiContext *imgui_c89_ctx);
float imgui_i_im_gui_table_get_header_row_height(ImGuiContext *imgui_c89_ctx);
int imgui_i_im_gui_table_get_hovered_row(ImGuiContext *imgui_c89_ctx);
ImGuiTableInstanceData * ImGui_TableGetInstanceData__27767b51c6(ImGuiTable * table, int instance_no);
ImGuiID ImGui_TableGetInstanceID__2cc2b4d93e(ImGuiTable * table, int instance_no);
void imgui_i_im_gui_table_init_column_defaults(ImGuiTable * table, ImGuiTableColumn * column, ImGuiTableColumnFlags init_mask);
void imgui_i_im_gui_table_load_settings(ImGuiContext *imgui_c89_ctx, ImGuiTable * table);
void imgui_i_im_gui_table_load_settings_for_column(ImGuiTableColumn * column, ImGuiTableColumnSettings * column_settings, ImGuiTableFlags load_flags);
void imgui_i_im_gui_table_load_settings_for_columns(ImGuiContext *imgui_c89_ctx, ImGuiTable * table);
void imgui_i_im_gui_table_merge_draw_channels(ImGuiContext *imgui_c89_ctx, ImGuiTable * table);
void imgui_i_im_gui_table_open_context_menu(ImGuiContext *imgui_c89_ctx, int column_n);
void imgui_i_im_gui_table_pop_background_channel(ImGuiContext *imgui_c89_ctx);
void imgui_i_im_gui_table_pop_column_channel(ImGuiContext *imgui_c89_ctx);
void imgui_i_im_gui_table_push_background_channel(ImGuiContext *imgui_c89_ctx);
void imgui_i_im_gui_table_push_column_channel(ImGuiContext *imgui_c89_ctx, int column_n);
void imgui_i_im_gui_table_queue_set_column_display_order(ImGuiTable * table, int column_n, int dst_order);
void imgui_i_im_gui_table_reconcile_columns(ImGuiContext *imgui_c89_ctx, ImGuiTable * table);
void imgui_i_im_gui_table_remove(ImGuiContext *imgui_c89_ctx, ImGuiTable * table);
void imgui_i_im_gui_table_reset_settings(ImGuiTable * table);
void imgui_i_im_gui_table_save_settings(ImGuiContext *imgui_c89_ctx, ImGuiTable * table);
void imgui_i_im_gui_table_set_column_display_order(ImGuiTable * table, int column_n, int dst_order);
void imgui_i_im_gui_table_set_column_sort_direction(ImGuiContext *imgui_c89_ctx, int column_n, ImGuiSortDirection sort_direction, unsigned char append_to_sort_specs);
void imgui_i_im_gui_table_set_column_width(ImGuiContext *imgui_c89_ctx, int column_n, float width);
void imgui_i_im_gui_table_set_column_width_auto_all(ImGuiTable * table);
void imgui_i_im_gui_table_set_column_width_auto_single(ImGuiTable * table, int column_n);
void imgui_i_im_gui_table_settings_add_settings_handler(ImGuiContext *imgui_c89_ctx);
ImGuiTableSettings * imgui_i_im_gui_table_settings_create(ImGuiContext *imgui_c89_ctx, ImGuiID id, int columns_count);
ImGuiTableSettings * imgui_i_im_gui_table_settings_find_by_id(ImGuiContext *imgui_c89_ctx, ImGuiID id);
void imgui_i_im_gui_table_setup_draw_channels(ImGuiContext *imgui_c89_ctx, ImGuiTable * table);
void imgui_i_im_gui_table_sort_specs_build(ImGuiContext *imgui_c89_ctx, ImGuiTable * table);
void imgui_i_im_gui_table_sort_specs_sanitize(ImGuiTable * table);
void imgui_i_im_gui_table_update_borders(ImGuiContext *imgui_c89_ctx, ImGuiTable * table);
void imgui_i_im_gui_table_update_columns_weight_from_width(ImGuiTable * table);
void imgui_i_im_gui_table_update_layout(ImGuiContext *imgui_c89_ctx, ImGuiTable * table);
void imgui_i_im_gui_teleport_mouse_pos(ImGuiContext *imgui_c89_ctx, const ImVec2 * pos);
...
unsigned char imgui_i_im_gui_test_key_owner(ImGuiContext *imgui_c89_ctx, ImGuiKey key, ImGuiID owner_id);
unsigned char imgui_i_im_gui_test_shortcut_routing(ImGuiContext *imgui_c89_ctx, ImGuiKeyChord key_chord, ImGuiID owner_id);
...
void imgui_i_im_gui_unregister_font_atlas(ImGuiContext *imgui_c89_ctx, ImFontAtlas * atlas);
void imgui_i_im_gui_unregister_user_texture(ImGuiContext *imgui_c89_ctx, ImTextureData * tex);
void imgui_i_im_gui_update_current_font_size(ImGuiContext *imgui_c89_ctx, float restore_font_size_after_scaling);
void imgui_i_im_gui_update_hovered_window_and_capture_flags(ImGuiContext *imgui_c89_ctx, const ImVec2 * mouse_pos);
void imgui_i_im_gui_update_input_events(ImGuiContext *imgui_c89_ctx, unsigned char trickle_fast_inputs);
void imgui_i_im_gui_update_mouse_moving_window_end_frame(ImGuiContext *imgui_c89_ctx);
void imgui_i_im_gui_update_mouse_moving_window_new_frame(ImGuiContext *imgui_c89_ctx);
void imgui_i_im_gui_update_window_parent_and_root_links(ImGuiWindow * window, ImGuiWindowFlags flags, ImGuiWindow * parent_window);
void imgui_i_im_gui_update_window_skip_refresh(ImGuiContext *imgui_c89_ctx, ImGuiWindow * window);
...
void imgui_i_im_gui_context_init(ImGuiContext *imgui_c89_ctx, ImGuiContext *self, ImFontAtlas * shared_font_atlas);
void imgui_i_im_gui_context_destroy(ImGuiContext *imgui_c89_ctx, ImGuiContext *self);
void imgui_i_im_gui_io_init(ImGuiIO *self);
...
void imgui_i_im_gui_list_clipper_init(ImGuiListClipper *self);
void imgui_i_im_gui_list_clipper_destroy(ImGuiContext *imgui_c89_ctx, ImGuiListClipper *self);
...
void ImGuiOldColumnData_ImGuiOldColumnData__958c8873b8(ImGuiOldColumnData *self);
void ImGuiOldColumns_ImGuiOldColumns__8d39d9f2e7(ImGuiOldColumns *self);
void ImGuiPackedDate_ImGuiPackedDate__a47500150f(ImGuiPackedDate *self, int yyyymmdd);
...
void imgui_i_im_gui_platform_io_init(ImGuiPlatformIO *self);
...
void ImGuiSettingsHandler_ImGuiSettingsHandler__b1f5a35313(ImGuiSettingsHandler *self);
void ImGuiStoragePair_ImGuiStoragePair__a5d3a535fc(ImGuiStoragePair *self, ImGuiID _key, int _val);
void imgui_i_im_gui_style_init(ImGuiContext *imgui_c89_ctx, ImGuiStyle *self);
void imgui_i_im_gui_tab_bar_init(ImGuiTabBar *self);
void ImGuiTabItem_ImGuiTabItem__9e73f47f28(ImGuiTabItem *self);
void ImGuiTable_ImGuiTable__a76470235f(ImGuiTable *self);
void ImGuiTable_dtor_ImGuiTable__272de0593a(ImGuiContext *imgui_c89_ctx, ImGuiTable *self);
void ImGuiTableColumn_ImGuiTableColumn__076012539a(ImGuiTableColumn *self);
void ImGuiTableColumnSettings_ImGuiTableColumnSettings__650a8eb1f5(ImGuiTableColumnSettings *self);
void ImGuiTableInstanceData_ImGuiTableInstanceData__2dcc41cc28(ImGuiTableInstanceData *self);
ImGuiTableColumnSettings * ImGuiTableSettings_GetColumnSettings__178ab60567(ImGuiTableSettings *self);
void ImGuiTableSettings_ImGuiTableSettings__15d1a90a5f(ImGuiTableSettings *self);
void ImGuiTableTempData_ImGuiTableTempData__94a2a9cfc9(ImGuiTableTempData *self);
void ImGuiTextBuffer_ImGuiTextBuffer__cf299f8f93(ImGuiTextBuffer *self);
void imgui_i_im_gui_text_buffer_appendf(ImGuiContext *imgui_c89_ctx, ImGuiTextBuffer *self, const char * fmt, ...);
void imgui_i_im_gui_text_filter_init(ImGuiContext *imgui_c89_ctx, ImGuiTextFilter *self, const char * default_filter);
void imgui_i_im_gui_text_index_append(ImGuiContext *imgui_c89_ctx, ImGuiTextIndex *self, const char * base, int old_size, int new_size);
...
ImGuiID imgui_i_im_gui_window_get_id_string_string(ImGuiContext *imgui_c89_ctx, ImGuiWindow *self, const char * str, const char * str_end);
ImGuiID imgui_i_im_gui_window_get_id_const_pointer(ImGuiContext *imgui_c89_ctx, ImGuiWindow *self, const void * ptr);
ImGuiID imgui_i_im_gui_window_get_id_int(ImGuiContext *imgui_c89_ctx, ImGuiWindow *self, int n);
ImGuiID imgui_i_im_gui_window_get_id_from_pos(ImGuiWindow *self, const ImVec2 * p_abs);
ImGuiID imgui_i_im_gui_window_get_id_from_rectangle(ImGuiWindow *self, const ImRect * r_abs);
void imgui_i_im_gui_window_init(ImGuiContext *imgui_c89_ctx, ImGuiWindow *self, ImGuiContext * ctx, const char * name);
ImRect ImGuiWindow_MenuBarRect__0336d8f646(ImGuiWindow *self);
ImRect ImGuiWindow_Rect__460e84dccd(ImGuiWindow *self);
void imgui_i_im_gui_window_destroy(ImGuiContext *imgui_c89_ctx, ImGuiWindow *self);
...
unsigned char ImPool_ImGuiTable__Contains__25bf296ba3(ImPool_ImGuiTable *self, const ImGuiTable * p);
int ImPool_ImGuiTable__GetBufSize__9c1901ee28(ImPool_ImGuiTable *self);
ImGuiTable * ImPool_ImGuiTable__GetByIndex__5cd9213811(ImPool_ImGuiTable *self, ImPoolIdx n);
int ImPool_ImGuiTable__GetMapSize__2b91536528(ImPool_ImGuiTable *self);
void ImPool_ImGuiTable__Reserve__3402ca0e63(ImPool_ImGuiTable *self, int capacity);
ImGuiTable * ImPool_ImGuiTable__TryGetMapData__3e6c159dd7(ImPool_ImGuiTable *self, ImPoolIdx n);
...
unsigned char ImRect_Contains__c9916e1cff(ImRect *self, const ImRect * r);
...
void ImRect_ImRect__576d8a9a92(ImRect *self, const ImVec4 * v);
...
ImVec4 ImRect_ToVec4__80b1b7e70a(ImRect *self);
void ImRect_Translate__44699a5176(ImRect *self, const ImVec2 * d);
void ImSpan_ImGuiTableCellData__ImSpan__1be690a0c0(ImSpan_ImGuiTableCellData *self, ImGuiTableCellData * data, int size);
void ImSpan_ImGuiTableCellData__ImSpan__20cfea6e52(ImSpan_ImGuiTableCellData *self, ImGuiTableCellData * data, ImGuiTableCellData * data_end);
ImGuiTableCellData * ImSpan_ImGuiTableCellData__begin__5e83c8bf41(ImSpan_ImGuiTableCellData *self);
const ImGuiTableCellData * ImSpan_ImGuiTableCellData__begin__808415a227(ImSpan_ImGuiTableCellData *self);
void ImSpan_ImGuiTableCellData__clear__8f1378100f(ImSpan_ImGuiTableCellData *self);
unsigned char ImSpan_ImGuiTableCellData__empty__b32c31673a(ImSpan_ImGuiTableCellData *self);
ImGuiTableCellData * ImSpan_ImGuiTableCellData__end__e542f9eca1(ImSpan_ImGuiTableCellData *self);
const ImGuiTableCellData * ImSpan_ImGuiTableCellData__end__1384482f4a(ImSpan_ImGuiTableCellData *self);
int ImSpan_ImGuiTableCellData__index_from_ptr__648598d903(ImSpan_ImGuiTableCellData *self, const ImGuiTableCellData * it);
const ImGuiTableCellData * ImSpan_ImGuiTableCellData__operator____38b79796ae(ImSpan_ImGuiTableCellData *self, int i);
void ImSpan_ImGuiTableCellData__set__f0852b015d(ImSpan_ImGuiTableCellData *self, ImGuiTableCellData * data, int size);
int ImSpan_ImGuiTableCellData__size__43d9bd9dd0(ImSpan_ImGuiTableCellData *self);
int ImSpan_ImGuiTableCellData__size_in_bytes__bbfea95ae1(ImSpan_ImGuiTableCellData *self);
void ImSpan_ImGuiTableColumn__ImSpan__ea5c598d30(ImSpan_ImGuiTableColumn *self, ImGuiTableColumn * data, int size);
void ImSpan_ImGuiTableColumn__ImSpan__8bcf998ea1(ImSpan_ImGuiTableColumn *self, ImGuiTableColumn * data, ImGuiTableColumn * data_end);
const ImGuiTableColumn * ImSpan_ImGuiTableColumn__begin__7603742a19(ImSpan_ImGuiTableColumn *self);
const ImGuiTableColumn * ImSpan_ImGuiTableColumn__end__4e63346290(ImSpan_ImGuiTableColumn *self);
ImGuiTableColumn * ImSpan_ImGuiTableColumn__operator____727a2e81c1(ImSpan_ImGuiTableColumn *self, int i);
void ImSpan_ImGuiTableColumn__set__3945592a2c(ImSpan_ImGuiTableColumn *self, ImGuiTableColumn * data, int size);
int ImSpan_ImGuiTableColumn__size_in_bytes__86a9fe2f92(ImSpan_ImGuiTableColumn *self);
void ImSpan_short__ImSpan__9cf811d05d(ImSpan_short *self, short * data, int size);
void ImSpan_short__ImSpan__c05a89275e(ImSpan_short *self, short * data, short * data_end);
short * ImSpan_short__begin__3e9e514829(ImSpan_short *self);
const short * ImSpan_short__begin__abd25f6043(ImSpan_short *self);
void ImSpan_short__clear__d7e93955d1(ImSpan_short *self);
unsigned char ImSpan_short__empty__3f2e28236f(ImSpan_short *self);
short * ImSpan_short__end__5744ef7f5b(ImSpan_short *self);
const short * ImSpan_short__end__1bf8fa8833(ImSpan_short *self);
int ImSpan_short__index_from_ptr__a039eb0565(ImSpan_short *self, const short * it);
const short * ImSpan_short__operator____f560485b0c(ImSpan_short *self, int i);
void ImSpan_short__set__95f7277b9c(ImSpan_short *self, short * data, int size);
int ImSpan_short__size__2f29376821(ImSpan_short *self);
int ImSpan_short__size_in_bytes__732ea75fb7(ImSpan_short *self);
...
ImDrawChannel * ImVector_ImDrawChannel__operator____096e2ae85f(ImVector_ImDrawChannel *self, int i);
...
ImDrawCmd * ImVector_ImDrawCmd__back__9e12f0cfc2(ImVector_ImDrawCmd *self);
...
ImFontAtlasRectEntry * ImVector_ImFontAtlasRectEntry__begin__d0e7c70e64(ImVector_ImFontAtlasRectEntry *self);
...
ImFontAtlasRectEntry * ImVector_ImFontAtlasRectEntry__end__1754b36f57(ImVector_ImFontAtlasRectEntry *self);
...
int ImVector_ImFontAtlasRectEntry__index_from_ptr__6330f5b866(ImVector_ImFontAtlasRectEntry *self, const ImFontAtlasRectEntry * it);
...
void ImVector_ImFontAtlasRectEntry__dtor_ImVector__1435912c4b(ImGuiContext *imgui_c89_ctx, ImVector_ImFontAtlasRectEntry *self);
...
void ImVector_ImGuiTable__ImVector__db2707778a(ImVector_ImGuiTable *self, const ImVector_ImGuiTable * src);
ImGuiTable * ImVector_ImGuiTable__back__58ec8f5427(ImVector_ImGuiTable *self);
const ImGuiTable * ImVector_ImGuiTable__back__79d65b9b67(ImVector_ImGuiTable *self);
ImGuiTable * ImVector_ImGuiTable__begin__8b7c9f26bb(ImVector_ImGuiTable *self);
const ImGuiTable * ImVector_ImGuiTable__begin__54bdbee598(ImVector_ImGuiTable *self);
int ImVector_ImGuiTable__capacity__e26f8ca6e0(ImVector_ImGuiTable *self);
void ImVector_ImGuiTable__clear_delete__ca8f5fd4f2(ImVector_ImGuiTable *self);
void ImVector_ImGuiTable__clear_destruct__4df70924b0(ImVector_ImGuiTable *self);
unsigned char ImVector_ImGuiTable__contains__50f8808236(ImVector_ImGuiTable *self, const ImGuiTable * v);
unsigned char ImVector_ImGuiTable__empty__29c9af6b1e(ImVector_ImGuiTable *self);
ImGuiTable * ImVector_ImGuiTable__end__7c1646b8d2(ImVector_ImGuiTable *self);
const ImGuiTable * ImVector_ImGuiTable__end__42a4282e42(ImVector_ImGuiTable *self);
ImGuiTable * ImVector_ImGuiTable__erase__8a6192a4f4(ImVector_ImGuiTable *self, const ImGuiTable * it);
ImGuiTable * ImVector_ImGuiTable__erase__b1e75f8f0f(ImVector_ImGuiTable *self, const ImGuiTable * it, const ImGuiTable * it_last);
ImGuiTable * ImVector_ImGuiTable__erase_unsorted__0b18982f6d(ImVector_ImGuiTable *self, const ImGuiTable * it);
ImGuiTable * ImVector_ImGuiTable__find__76ac6ed442(ImVector_ImGuiTable *self, const ImGuiTable * v);
const ImGuiTable * ImVector_ImGuiTable__find__7cab384b74(ImVector_ImGuiTable *self, const ImGuiTable * v);
unsigned char ImVector_ImGuiTable__find_erase__1cba223a15(ImVector_ImGuiTable *self, const ImGuiTable * v);
unsigned char ImVector_ImGuiTable__find_erase_unsorted__10ded4757d(ImVector_ImGuiTable *self, const ImGuiTable * v);
int ImVector_ImGuiTable__find_index__55eddfa09a(ImVector_ImGuiTable *self, const ImGuiTable * v);
ImGuiTable * ImVector_ImGuiTable__front__cd2a9bfceb(ImVector_ImGuiTable *self);
const ImGuiTable * ImVector_ImGuiTable__front__423ff2f72b(ImVector_ImGuiTable *self);
int ImVector_ImGuiTable__index_from_ptr__f1924f56bd(ImVector_ImGuiTable *self, const ImGuiTable * it);
ImGuiTable * ImVector_ImGuiTable__insert__8710aaf2b6(ImVector_ImGuiTable *self, const ImGuiTable * it, const ImGuiTable * v);
int ImVector_ImGuiTable__max_size__8d0e5f8b93(ImVector_ImGuiTable *self);
ImVector_ImGuiTable * ImVector_ImGuiTable__operator___255734ee82(ImVector_ImGuiTable *self, const ImVector_ImGuiTable * src);
ImGuiTable * ImVector_ImGuiTable__operator____d7d8a488b4(ImVector_ImGuiTable *self, int i);
const ImGuiTable * ImVector_ImGuiTable__operator____b64b77552a(ImVector_ImGuiTable *self, int i);
void ImVector_ImGuiTable__pop_back__ff92579239(ImVector_ImGuiTable *self);
void ImVector_ImGuiTable__push_back__1fdd4f319d(ImVector_ImGuiTable *self, const ImGuiTable * v);
void ImVector_ImGuiTable__push_front__b42c276088(ImVector_ImGuiTable *self, const ImGuiTable * v);
void ImVector_ImGuiTable__reserve_discard__acd103ce68(ImVector_ImGuiTable *self, int new_capacity);
void ImVector_ImGuiTable__resize__0a499128cb(ImVector_ImGuiTable *self, int new_size, const ImGuiTable * v);
void ImVector_ImGuiTable__shrink__bf448b76a6(ImVector_ImGuiTable *self, int new_size);
int ImVector_ImGuiTable__size__d66f85ced5(ImVector_ImGuiTable *self);
int ImVector_ImGuiTable__size_in_bytes__ec26a9fe0a(ImVector_ImGuiTable *self);
void ImVector_ImGuiTable__swap__3d3bef5b81(ImVector_ImGuiTable *self, ImVector_ImGuiTable * rhs);
void ImVector_ImGuiTableColumnSortSpecs__ImVector__c010f83761(ImVector_ImGuiTableColumnSortSpecs *self, const ImVector_ImGuiTableColumnSortSpecs * src);
ImGuiTableColumnSortSpecs * ImVector_ImGuiTableColumnSortSpecs__back__78fbf19dad(ImVector_ImGuiTableColumnSortSpecs *self);
const ImGuiTableColumnSortSpecs * ImVector_ImGuiTableColumnSortSpecs__back__e9de9c318f(ImVector_ImGuiTableColumnSortSpecs *self);
ImGuiTableColumnSortSpecs * ImVector_ImGuiTableColumnSortSpecs__begin__d3b701487b(ImVector_ImGuiTableColumnSortSpecs *self);
const ImGuiTableColumnSortSpecs * ImVector_ImGuiTableColumnSortSpecs__begin__7db3c94da9(ImVector_ImGuiTableColumnSortSpecs *self);
int ImVector_ImGuiTableColumnSortSpecs__capacity__e9d06a9415(ImVector_ImGuiTableColumnSortSpecs *self);
void ImVector_ImGuiTableColumnSortSpecs__clear_delete__f89f16cc0a(ImVector_ImGuiTableColumnSortSpecs *self);
void ImVector_ImGuiTableColumnSortSpecs__clear_destruct__2b502abdfa(ImVector_ImGuiTableColumnSortSpecs *self);
unsigned char ImVector_ImGuiTableColumnSortSpecs__contains__1834ab8b60(ImVector_ImGuiTableColumnSortSpecs *self, const ImGuiTableColumnSortSpecs * v);
unsigned char ImVector_ImGuiTableColumnSortSpecs__empty__661ca4f77c(ImVector_ImGuiTableColumnSortSpecs *self);
ImGuiTableColumnSortSpecs * ImVector_ImGuiTableColumnSortSpecs__end__eb24f2ccbb(ImVector_ImGuiTableColumnSortSpecs *self);
const ImGuiTableColumnSortSpecs * ImVector_ImGuiTableColumnSortSpecs__end__c191e6e0b7(ImVector_ImGuiTableColumnSortSpecs *self);
ImGuiTableColumnSortSpecs * ImVector_ImGuiTableColumnSortSpecs__erase__41de94fe3a(ImVector_ImGuiTableColumnSortSpecs *self, const ImGuiTableColumnSortSpecs * it);
ImGuiTableColumnSortSpecs * ImVector_ImGuiTableColumnSortSpecs__erase__a88a27098c(ImVector_ImGuiTableColumnSortSpecs *self, const ImGuiTableColumnSortSpecs * it, const ImGuiTableColumnSortSpecs * it_last);
ImGuiTableColumnSortSpecs * ImVector_ImGuiTableColumnSortSpecs__erase_unsorted__8115502b8d(ImVector_ImGuiTableColumnSortSpecs *self, const ImGuiTableColumnSortSpecs * it);
ImGuiTableColumnSortSpecs * ImVector_ImGuiTableColumnSortSpecs__find__261690bdc1(ImVector_ImGuiTableColumnSortSpecs *self, const ImGuiTableColumnSortSpecs * v);
const ImGuiTableColumnSortSpecs * ImVector_ImGuiTableColumnSortSpecs__find__6fdb5675eb(ImVector_ImGuiTableColumnSortSpecs *self, const ImGuiTableColumnSortSpecs * v);
unsigned char ImVector_ImGuiTableColumnSortSpecs__find_erase__d7135c7213(ImVector_ImGuiTableColumnSortSpecs *self, const ImGuiTableColumnSortSpecs * v);
unsigned char ImVector_ImGuiTableColumnSortSpecs__find_erase_unsorted__08ddc8ac99(ImVector_ImGuiTableColumnSortSpecs *self, const ImGuiTableColumnSortSpecs * v);
int ImVector_ImGuiTableColumnSortSpecs__find_index__91f3a7fbf4(ImVector_ImGuiTableColumnSortSpecs *self, const ImGuiTableColumnSortSpecs * v);
ImGuiTableColumnSortSpecs * ImVector_ImGuiTableColumnSortSpecs__front__fba9095e08(ImVector_ImGuiTableColumnSortSpecs *self);
const ImGuiTableColumnSortSpecs * ImVector_ImGuiTableColumnSortSpecs__front__435f929b8e(ImVector_ImGuiTableColumnSortSpecs *self);
int ImVector_ImGuiTableColumnSortSpecs__index_from_ptr__1c88de42fa(ImVector_ImGuiTableColumnSortSpecs *self, const ImGuiTableColumnSortSpecs * it);
ImGuiTableColumnSortSpecs * ImVector_ImGuiTableColumnSortSpecs__insert__53c7c03ca2(ImVector_ImGuiTableColumnSortSpecs *self, const ImGuiTableColumnSortSpecs * it, const ImGuiTableColumnSortSpecs * v);
int ImVector_ImGuiTableColumnSortSpecs__max_size__bd41b155f8(ImVector_ImGuiTableColumnSortSpecs *self);
ImVector_ImGuiTableColumnSortSpecs * ImVector_ImGuiTableColumnSortSpecs__operator___2e386b6a99(ImVector_ImGuiTableColumnSortSpecs *self, const ImVector_ImGuiTableColumnSortSpecs * src);
ImGuiTableColumnSortSpecs * ImVector_ImGuiTableColumnSortSpecs__operator____220d357448(ImVector_ImGuiTableColumnSortSpecs *self, int i);
const ImGuiTableColumnSortSpecs * ImVector_ImGuiTableColumnSortSpecs__operator____50bfcf0eac(ImVector_ImGuiTableColumnSortSpecs *self, int i);
void ImVector_ImGuiTableColumnSortSpecs__pop_back__d4636fbbec(ImVector_ImGuiTableColumnSortSpecs *self);
void ImVector_ImGuiTableColumnSortSpecs__push_back__d187794723(ImVector_ImGuiTableColumnSortSpecs *self, const ImGuiTableColumnSortSpecs * v);
void ImVector_ImGuiTableColumnSortSpecs__push_front__6184bc6c3b(ImVector_ImGuiTableColumnSortSpecs *self, const ImGuiTableColumnSortSpecs * v);
void ImVector_ImGuiTableColumnSortSpecs__reserve_discard__9d764500bf(ImVector_ImGuiTableColumnSortSpecs *self, int new_capacity);
void ImVector_ImGuiTableColumnSortSpecs__resize__7f413fadf6(ImVector_ImGuiTableColumnSortSpecs *self, int new_size, const ImGuiTableColumnSortSpecs * v);
void ImVector_ImGuiTableColumnSortSpecs__shrink__9b29eb84ba(ImVector_ImGuiTableColumnSortSpecs *self, int new_size);
int ImVector_ImGuiTableColumnSortSpecs__size__9d09fb0601(ImVector_ImGuiTableColumnSortSpecs *self);
int ImVector_ImGuiTableColumnSortSpecs__size_in_bytes__c2a606b733(ImVector_ImGuiTableColumnSortSpecs *self);
void ImVector_ImGuiTableColumnSortSpecs__swap__95c5e6f2b0(ImVector_ImGuiTableColumnSortSpecs *self, ImVector_ImGuiTableColumnSortSpecs * rhs);
void ImVector_ImGuiTableHeaderData__ImVector__96d62199a5(ImVector_ImGuiTableHeaderData *self, const ImVector_ImGuiTableHeaderData * src);
ImGuiTableHeaderData * ImVector_ImGuiTableHeaderData__back__dab3923573(ImVector_ImGuiTableHeaderData *self);
const ImGuiTableHeaderData * ImVector_ImGuiTableHeaderData__back__b89ecdcae1(ImVector_ImGuiTableHeaderData *self);
ImGuiTableHeaderData * ImVector_ImGuiTableHeaderData__begin__6e878d26b4(ImVector_ImGuiTableHeaderData *self);
const ImGuiTableHeaderData * ImVector_ImGuiTableHeaderData__begin__29430b1967(ImVector_ImGuiTableHeaderData *self);
int ImVector_ImGuiTableHeaderData__capacity__8ed99fefd1(ImVector_ImGuiTableHeaderData *self);
void ImVector_ImGuiTableHeaderData__clear_delete__13557927f9(ImVector_ImGuiTableHeaderData *self);
void ImVector_ImGuiTableHeaderData__clear_destruct__ba75e62f3a(ImVector_ImGuiTableHeaderData *self);
unsigned char ImVector_ImGuiTableHeaderData__contains__ecae41c3e7(ImVector_ImGuiTableHeaderData *self, const ImGuiTableHeaderData * v);
unsigned char ImVector_ImGuiTableHeaderData__empty__af62d22e25(ImVector_ImGuiTableHeaderData *self);
ImGuiTableHeaderData * ImVector_ImGuiTableHeaderData__end__fc8d3b3ff8(ImVector_ImGuiTableHeaderData *self);
const ImGuiTableHeaderData * ImVector_ImGuiTableHeaderData__end__76b24dc140(ImVector_ImGuiTableHeaderData *self);
ImGuiTableHeaderData * ImVector_ImGuiTableHeaderData__erase__17c52e4db9(ImVector_ImGuiTableHeaderData *self, const ImGuiTableHeaderData * it);
ImGuiTableHeaderData * ImVector_ImGuiTableHeaderData__erase__a9df2f33c0(ImVector_ImGuiTableHeaderData *self, const ImGuiTableHeaderData * it, const ImGuiTableHeaderData * it_last);
ImGuiTableHeaderData * ImVector_ImGuiTableHeaderData__erase_unsorted__62c8c17bc4(ImVector_ImGuiTableHeaderData *self, const ImGuiTableHeaderData * it);
ImGuiTableHeaderData * ImVector_ImGuiTableHeaderData__find__e510a36f0d(ImVector_ImGuiTableHeaderData *self, const ImGuiTableHeaderData * v);
const ImGuiTableHeaderData * ImVector_ImGuiTableHeaderData__find__8badd3f14a(ImVector_ImGuiTableHeaderData *self, const ImGuiTableHeaderData * v);
unsigned char ImVector_ImGuiTableHeaderData__find_erase__2aa18aee6c(ImVector_ImGuiTableHeaderData *self, const ImGuiTableHeaderData * v);
unsigned char ImVector_ImGuiTableHeaderData__find_erase_unsorted__6aab345a80(ImVector_ImGuiTableHeaderData *self, const ImGuiTableHeaderData * v);
int ImVector_ImGuiTableHeaderData__find_index__0fd9efdcd0(ImVector_ImGuiTableHeaderData *self, const ImGuiTableHeaderData * v);
ImGuiTableHeaderData * ImVector_ImGuiTableHeaderData__front__8c582781c6(ImVector_ImGuiTableHeaderData *self);
const ImGuiTableHeaderData * ImVector_ImGuiTableHeaderData__front__550a2e5bb7(ImVector_ImGuiTableHeaderData *self);
int ImVector_ImGuiTableHeaderData__index_from_ptr__86b43ee722(ImVector_ImGuiTableHeaderData *self, const ImGuiTableHeaderData * it);
ImGuiTableHeaderData * ImVector_ImGuiTableHeaderData__insert__d673f3cef8(ImVector_ImGuiTableHeaderData *self, const ImGuiTableHeaderData * it, const ImGuiTableHeaderData * v);
int ImVector_ImGuiTableHeaderData__max_size__81eea28e17(ImVector_ImGuiTableHeaderData *self);
ImVector_ImGuiTableHeaderData * ImVector_ImGuiTableHeaderData__operator___c63c9e6e99(ImVector_ImGuiTableHeaderData *self, const ImVector_ImGuiTableHeaderData * src);
ImGuiTableHeaderData * ImVector_ImGuiTableHeaderData__operator____8078ffb986(ImVector_ImGuiTableHeaderData *self, int i);
const ImGuiTableHeaderData * ImVector_ImGuiTableHeaderData__operator____d777515a8e(ImVector_ImGuiTableHeaderData *self, int i);
void ImVector_ImGuiTableHeaderData__pop_back__76151271d2(ImVector_ImGuiTableHeaderData *self);
void ImVector_ImGuiTableHeaderData__push_front__9427b11de7(ImVector_ImGuiTableHeaderData *self, const ImGuiTableHeaderData * v);
void ImVector_ImGuiTableHeaderData__reserve_discard__303bc23c53(ImVector_ImGuiTableHeaderData *self, int new_capacity);
void ImVector_ImGuiTableHeaderData__resize__04d56cc746(ImVector_ImGuiTableHeaderData *self, int new_size, const ImGuiTableHeaderData * v);
void ImVector_ImGuiTableHeaderData__shrink__f5956fbb02(ImVector_ImGuiTableHeaderData *self, int new_size);
int ImVector_ImGuiTableHeaderData__size__0748897aaf(ImVector_ImGuiTableHeaderData *self);
int ImVector_ImGuiTableHeaderData__size_in_bytes__a85858ad96(ImVector_ImGuiTableHeaderData *self);
void ImVector_ImGuiTableHeaderData__swap__fd71c2dfd8(ImVector_ImGuiTableHeaderData *self, ImVector_ImGuiTableHeaderData * rhs);
void ImVector_ImGuiTableInstanceData__ImVector__a937ca8b2d(ImVector_ImGuiTableInstanceData *self, const ImVector_ImGuiTableInstanceData * src);
ImGuiTableInstanceData * ImVector_ImGuiTableInstanceData__back__b6ab877560(ImVector_ImGuiTableInstanceData *self);
const ImGuiTableInstanceData * ImVector_ImGuiTableInstanceData__back__5f93a6ce42(ImVector_ImGuiTableInstanceData *self);
ImGuiTableInstanceData * ImVector_ImGuiTableInstanceData__begin__2741a4c682(ImVector_ImGuiTableInstanceData *self);
const ImGuiTableInstanceData * ImVector_ImGuiTableInstanceData__begin__6071479881(ImVector_ImGuiTableInstanceData *self);
int ImVector_ImGuiTableInstanceData__capacity__8c8b45a141(ImVector_ImGuiTableInstanceData *self);
void ImVector_ImGuiTableInstanceData__clear__c857f3d171(ImVector_ImGuiTableInstanceData *self);
void ImVector_ImGuiTableInstanceData__clear_delete__39e7b726e3(ImVector_ImGuiTableInstanceData *self);
void ImVector_ImGuiTableInstanceData__clear_destruct__241eb124c0(ImVector_ImGuiTableInstanceData *self);
unsigned char ImVector_ImGuiTableInstanceData__contains__9d7257b1d7(ImVector_ImGuiTableInstanceData *self, const ImGuiTableInstanceData * v);
unsigned char ImVector_ImGuiTableInstanceData__empty__79aec7a37e(ImVector_ImGuiTableInstanceData *self);
ImGuiTableInstanceData * ImVector_ImGuiTableInstanceData__end__b85a2b238b(ImVector_ImGuiTableInstanceData *self);
const ImGuiTableInstanceData * ImVector_ImGuiTableInstanceData__end__a7710b086c(ImVector_ImGuiTableInstanceData *self);
ImGuiTableInstanceData * ImVector_ImGuiTableInstanceData__erase__2246137da8(ImVector_ImGuiTableInstanceData *self, const ImGuiTableInstanceData * it);
ImGuiTableInstanceData * ImVector_ImGuiTableInstanceData__erase__15b182dc50(ImVector_ImGuiTableInstanceData *self, const ImGuiTableInstanceData * it, const ImGuiTableInstanceData * it_last);
ImGuiTableInstanceData * ImVector_ImGuiTableInstanceData__erase_unsorted__965544f6d2(ImVector_ImGuiTableInstanceData *self, const ImGuiTableInstanceData * it);
ImGuiTableInstanceData * ImVector_ImGuiTableInstanceData__find__39b4e7cc0e(ImVector_ImGuiTableInstanceData *self, const ImGuiTableInstanceData * v);
const ImGuiTableInstanceData * ImVector_ImGuiTableInstanceData__find__fee831e876(ImVector_ImGuiTableInstanceData *self, const ImGuiTableInstanceData * v);
unsigned char ImVector_ImGuiTableInstanceData__find_erase__9cf554a8bb(ImVector_ImGuiTableInstanceData *self, const ImGuiTableInstanceData * v);
unsigned char ImVector_ImGuiTableInstanceData__find_erase_unsorted__f9a3ec2502(ImVector_ImGuiTableInstanceData *self, const ImGuiTableInstanceData * v);
int ImVector_ImGuiTableInstanceData__find_index__5e3471f9e0(ImVector_ImGuiTableInstanceData *self, const ImGuiTableInstanceData * v);
ImGuiTableInstanceData * ImVector_ImGuiTableInstanceData__front__f56bacbf41(ImVector_ImGuiTableInstanceData *self);
const ImGuiTableInstanceData * ImVector_ImGuiTableInstanceData__front__d050487205(ImVector_ImGuiTableInstanceData *self);
int ImVector_ImGuiTableInstanceData__index_from_ptr__205c443593(ImVector_ImGuiTableInstanceData *self, const ImGuiTableInstanceData * it);
ImGuiTableInstanceData * ImVector_ImGuiTableInstanceData__insert__a33820f622(ImVector_ImGuiTableInstanceData *self, const ImGuiTableInstanceData * it, const ImGuiTableInstanceData * v);
int ImVector_ImGuiTableInstanceData__max_size__00a1b55aa0(ImVector_ImGuiTableInstanceData *self);
ImVector_ImGuiTableInstanceData * ImVector_ImGuiTableInstanceData__operator___22dec729a5(ImVector_ImGuiTableInstanceData *self, const ImVector_ImGuiTableInstanceData * src);
const ImGuiTableInstanceData * ImVector_ImGuiTableInstanceData__operator____e245f088bb(ImVector_ImGuiTableInstanceData *self, int i);
void ImVector_ImGuiTableInstanceData__pop_back__be4f1c41c7(ImVector_ImGuiTableInstanceData *self);
void ImVector_ImGuiTableInstanceData__push_front__24f70af0d4(ImVector_ImGuiTableInstanceData *self, const ImGuiTableInstanceData * v);
void ImVector_ImGuiTableInstanceData__reserve_discard__46d6f7fcd8(ImVector_ImGuiTableInstanceData *self, int new_capacity);
void ImVector_ImGuiTableInstanceData__resize__10ce04e853(ImVector_ImGuiTableInstanceData *self, int new_size);
void ImVector_ImGuiTableInstanceData__resize__84bb39bfd6(ImVector_ImGuiTableInstanceData *self, int new_size, const ImGuiTableInstanceData * v);
void ImVector_ImGuiTableInstanceData__shrink__1a4623607e(ImVector_ImGuiTableInstanceData *self, int new_size);
int ImVector_ImGuiTableInstanceData__size__317a589ddc(ImVector_ImGuiTableInstanceData *self);
int ImVector_ImGuiTableInstanceData__size_in_bytes__24021af159(ImVector_ImGuiTableInstanceData *self);
void ImVector_ImGuiTableInstanceData__swap__08136d7323(ImVector_ImGuiTableInstanceData *self, ImVector_ImGuiTableInstanceData * rhs);
void ImVector_ImGuiTableReconcileColumnData__ImVector__060d538eb8(ImVector_ImGuiTableReconcileColumnData *self, const ImVector_ImGuiTableReconcileColumnData * src);
const ImGuiTableReconcileColumnData * ImVector_ImGuiTableReconcileColumnData__back__981615efc0(ImVector_ImGuiTableReconcileColumnData *self);
const ImGuiTableReconcileColumnData * ImVector_ImGuiTableReconcileColumnData__begin__ef3700d5d6(ImVector_ImGuiTableReconcileColumnData *self);
int ImVector_ImGuiTableReconcileColumnData__capacity__c4f9fdcf8b(ImVector_ImGuiTableReconcileColumnData *self);
void ImVector_ImGuiTableReconcileColumnData__clear_delete__306589a10e(ImVector_ImGuiTableReconcileColumnData *self);
void ImVector_ImGuiTableReconcileColumnData__clear_destruct__854753189b(ImVector_ImGuiTableReconcileColumnData *self);
unsigned char ImVector_ImGuiTableReconcileColumnData__contains__50f025bb1d(ImVector_ImGuiTableReconcileColumnData *self, const ImGuiTableReconcileColumnData * v);
unsigned char ImVector_ImGuiTableReconcileColumnData__empty__2dc6294bb3(ImVector_ImGuiTableReconcileColumnData *self);
const ImGuiTableReconcileColumnData * ImVector_ImGuiTableReconcileColumnData__end__5f3b4afab7(ImVector_ImGuiTableReconcileColumnData *self);
ImGuiTableReconcileColumnData * ImVector_ImGuiTableReconcileColumnData__erase__48cea824bb(ImVector_ImGuiTableReconcileColumnData *self, const ImGuiTableReconcileColumnData * it);
ImGuiTableReconcileColumnData * ImVector_ImGuiTableReconcileColumnData__erase__3c9fea8bef(ImVector_ImGuiTableReconcileColumnData *self, const ImGuiTableReconcileColumnData * it, const ImGuiTableReconcileColumnData * it_last);
ImGuiTableReconcileColumnData * ImVector_ImGuiTableReconcileColumnData__erase_unsorted__768d97bde0(ImVector_ImGuiTableReconcileColumnData *self, const ImGuiTableReconcileColumnData * it);
ImGuiTableReconcileColumnData * ImVector_ImGuiTableReconcileColumnData__find__0b7e4e9c62(ImVector_ImGuiTableReconcileColumnData *self, const ImGuiTableReconcileColumnData * v);
const ImGuiTableReconcileColumnData * ImVector_ImGuiTableReconcileColumnData__find__ed010b7e11(ImVector_ImGuiTableReconcileColumnData *self, const ImGuiTableReconcileColumnData * v);
unsigned char ImVector_ImGuiTableReconcileColumnData__find_erase__1571d9c1a1(ImVector_ImGuiTableReconcileColumnData *self, const ImGuiTableReconcileColumnData * v);
unsigned char ImVector_ImGuiTableReconcileColumnData__find_erase_unsorted__f64ec9714e(ImVector_ImGuiTableReconcileColumnData *self, const ImGuiTableReconcileColumnData * v);
int ImVector_ImGuiTableReconcileColumnData__find_index__697a06cc37(ImVector_ImGuiTableReconcileColumnData *self, const ImGuiTableReconcileColumnData * v);
ImGuiTableReconcileColumnData * ImVector_ImGuiTableReconcileColumnData__front__5dceb3398f(ImVector_ImGuiTableReconcileColumnData *self);
const ImGuiTableReconcileColumnData * ImVector_ImGuiTableReconcileColumnData__front__37fcc61cd9(ImVector_ImGuiTableReconcileColumnData *self);
int ImVector_ImGuiTableReconcileColumnData__index_from_ptr__03c949d5b0(ImVector_ImGuiTableReconcileColumnData *self, const ImGuiTableReconcileColumnData * it);
ImGuiTableReconcileColumnData * ImVector_ImGuiTableReconcileColumnData__insert__489496664c(ImVector_ImGuiTableReconcileColumnData *self, const ImGuiTableReconcileColumnData * it, const ImGuiTableReconcileColumnData * v);
int ImVector_ImGuiTableReconcileColumnData__max_size__f9de7f2e18(ImVector_ImGuiTableReconcileColumnData *self);
ImVector_ImGuiTableReconcileColumnData * ImVector_ImGuiTableReconcileColumnData__operator___2134d819c3(ImVector_ImGuiTableReconcileColumnData *self, const ImVector_ImGuiTableReconcileColumnData * src);
const ImGuiTableReconcileColumnData * ImVector_ImGuiTableReconcileColumnData__operator____4267e23647(ImVector_ImGuiTableReconcileColumnData *self, int i);
void ImVector_ImGuiTableReconcileColumnData__pop_back__e7c02885ca(ImVector_ImGuiTableReconcileColumnData *self);
void ImVector_ImGuiTableReconcileColumnData__push_front__5192fe6a04(ImVector_ImGuiTableReconcileColumnData *self, const ImGuiTableReconcileColumnData * v);
void ImVector_ImGuiTableReconcileColumnData__reserve_discard__9c3b4a9472(ImVector_ImGuiTableReconcileColumnData *self, int new_capacity);
void ImVector_ImGuiTableReconcileColumnData__resize__3e3cf4fbd5(ImVector_ImGuiTableReconcileColumnData *self, int new_size, const ImGuiTableReconcileColumnData * v);
void ImVector_ImGuiTableReconcileColumnData__shrink__bc7a384432(ImVector_ImGuiTableReconcileColumnData *self, int new_size);
int ImVector_ImGuiTableReconcileColumnData__size__caca25739c(ImVector_ImGuiTableReconcileColumnData *self);
int ImVector_ImGuiTableReconcileColumnData__size_in_bytes__4e5fa91ae1(ImVector_ImGuiTableReconcileColumnData *self);
void ImVector_ImGuiTableReconcileColumnData__swap__4665636ee4(ImVector_ImGuiTableReconcileColumnData *self, ImVector_ImGuiTableReconcileColumnData * rhs);
void ImVector_ImGuiTableTempData__ImVector__1741573947(ImVector_ImGuiTableTempData *self, const ImVector_ImGuiTableTempData * src);
ImGuiTableTempData * ImVector_ImGuiTableTempData__back__156d30bbb6(ImVector_ImGuiTableTempData *self);
const ImGuiTableTempData * ImVector_ImGuiTableTempData__back__91fdb6f84d(ImVector_ImGuiTableTempData *self);
const ImGuiTableTempData * ImVector_ImGuiTableTempData__begin__b4de8b0408(ImVector_ImGuiTableTempData *self);
int ImVector_ImGuiTableTempData__capacity__7515e739c6(ImVector_ImGuiTableTempData *self);
void ImVector_ImGuiTableTempData__clear_delete__e453b83e89(ImVector_ImGuiTableTempData *self);
unsigned char ImVector_ImGuiTableTempData__contains__fb58706389(ImVector_ImGuiTableTempData *self, const ImGuiTableTempData * v);
unsigned char ImVector_ImGuiTableTempData__empty__575154a6b5(ImVector_ImGuiTableTempData *self);
const ImGuiTableTempData * ImVector_ImGuiTableTempData__end__560e04d918(ImVector_ImGuiTableTempData *self);
ImGuiTableTempData * ImVector_ImGuiTableTempData__erase__5c1e6fe26d(ImVector_ImGuiTableTempData *self, const ImGuiTableTempData * it);
ImGuiTableTempData * ImVector_ImGuiTableTempData__erase__aebebfb4b7(ImVector_ImGuiTableTempData *self, const ImGuiTableTempData * it, const ImGuiTableTempData * it_last);
ImGuiTableTempData * ImVector_ImGuiTableTempData__erase_unsorted__6fdb80ff73(ImVector_ImGuiTableTempData *self, const ImGuiTableTempData * it);
ImGuiTableTempData * ImVector_ImGuiTableTempData__find__e5e06e06b8(ImVector_ImGuiTableTempData *self, const ImGuiTableTempData * v);
const ImGuiTableTempData * ImVector_ImGuiTableTempData__find__164d4b56f3(ImVector_ImGuiTableTempData *self, const ImGuiTableTempData * v);
unsigned char ImVector_ImGuiTableTempData__find_erase__86b16b0d28(ImVector_ImGuiTableTempData *self, const ImGuiTableTempData * v);
unsigned char ImVector_ImGuiTableTempData__find_erase_unsorted__8d1550a247(ImVector_ImGuiTableTempData *self, const ImGuiTableTempData * v);
int ImVector_ImGuiTableTempData__find_index__65f1f4a1ac(ImVector_ImGuiTableTempData *self, const ImGuiTableTempData * v);
ImGuiTableTempData * ImVector_ImGuiTableTempData__front__3f38e01ff7(ImVector_ImGuiTableTempData *self);
const ImGuiTableTempData * ImVector_ImGuiTableTempData__front__0b86438e0e(ImVector_ImGuiTableTempData *self);
int ImVector_ImGuiTableTempData__index_from_ptr__f626cb249d(ImVector_ImGuiTableTempData *self, const ImGuiTableTempData * it);
ImGuiTableTempData * ImVector_ImGuiTableTempData__insert__c980868781(ImVector_ImGuiTableTempData *self, const ImGuiTableTempData * it, const ImGuiTableTempData * v);
int ImVector_ImGuiTableTempData__max_size__e07f108f51(ImVector_ImGuiTableTempData *self);
ImVector_ImGuiTableTempData * ImVector_ImGuiTableTempData__operator___10e461d0a5(ImVector_ImGuiTableTempData *self, const ImVector_ImGuiTableTempData * src);
const ImGuiTableTempData * ImVector_ImGuiTableTempData__operator____d9eed939a8(ImVector_ImGuiTableTempData *self, int i);
void ImVector_ImGuiTableTempData__pop_back__64742e8800(ImVector_ImGuiTableTempData *self);
void ImVector_ImGuiTableTempData__push_back__86cddd8601(ImVector_ImGuiTableTempData *self, const ImGuiTableTempData * v);
void ImVector_ImGuiTableTempData__push_front__6f114a1499(ImVector_ImGuiTableTempData *self, const ImGuiTableTempData * v);
void ImVector_ImGuiTableTempData__reserve_discard__0947edbffe(ImVector_ImGuiTableTempData *self, int new_capacity);
void ImVector_ImGuiTableTempData__resize__53054898e9(ImVector_ImGuiTableTempData *self, int new_size);
void ImVector_ImGuiTableTempData__shrink__6286175a65(ImVector_ImGuiTableTempData *self, int new_size);
int ImVector_ImGuiTableTempData__size__e5c321d8cf(ImVector_ImGuiTableTempData *self);
int ImVector_ImGuiTableTempData__size_in_bytes__bdfeef8fd4(ImVector_ImGuiTableTempData *self);
void ImVector_ImGuiTableTempData__swap__510bbb3d06(ImVector_ImGuiTableTempData *self, ImVector_ImGuiTableTempData * rhs);
...
void ImVector_ImTextureRect__ImVector__4a9782721e(ImVector_ImTextureRect *self);
...
void ImVector_ImTextureRect__dtor_ImVector__e3e8dcd7b5(ImGuiContext *imgui_c89_ctx, ImVector_ImTextureRect *self);
...
ImVec4 * ImVector_ImVec4__back__4bb95f8b77(ImVector_ImVec4 *self);
...
void ImVector_float__resize__8e3f413a04(ImGuiContext *imgui_c89_ctx, ImVector_float *self, int new_size, const float * v);
